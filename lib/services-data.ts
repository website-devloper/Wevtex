...
export const SERVICES: Service[] = [
  {
    ...
    tech: {
      ...
      groups: [
        { label: "Frontend", desc: "A fast, modern interface layer your users feel instantly.", items: ["React", "Next.js", "TypeScript", "Tailwind"] },
        { label: "Backend & APIs", desc: "Reliable server logic and clean APIs that scale with you.", items: ["Node.js", "REST", "GraphQL", "Prisma"] },
        { label: "Commerce", desc: "Sell securely with proven, flexible commerce tooling.", items: ["Stripe", "WooCommerce", "Medusa"] },
        { label: "Infra & SEO", desc: "Edge hosting and technical SEO baked in from day one.", items: ["Vercel", "ISR", "JSON-LD", "Analytics"] },
      ],
    },
    process: {
      title: "How we work\ntogether.",
  ...
  },
  {
    ...
    tech: {
      ...
      groups: [
        { label: "Platforms", desc: "Battle-tested storefronts that grow with your catalog.", items: ["WooCommerce", "Shopify", "Medusa"] },
        { label: "Payments", desc: "Smooth, secure checkout with the gateways shoppers trust.", items: ["Stripe", "PayPal", "Local pay"] },
        { label: "Frontend", desc: "A snappy, mobile-first storefront built to convert.", items: ["Next.js", "React", "Tailwind"] },
        { label: "Growth", desc: "The data and hooks you need to sell more, repeatedly.", items: ["Analytics", "Schema", "Email"] },
      ],
    },
    process: STANDARD_PROCESS,
    sectors: {
  ...
  },
  {
    ...
    tech: {
      ...
      groups: [
        { label: "Platforms", desc: "Open, proven business platforms — or a custom fit.", items: ["Dolibarr", "Odoo", "Custom"] },
        { label: "Data", desc: "A solid data core your whole operation can rely on.", items: ["PostgreSQL", "MySQL", "APIs"] },
        { label: "Integrations", desc: "Connect the tools you already use, end to end.", items: ["WooCommerce", "Stripe", "Webhooks"] },
        { label: "Reporting", desc: "Clear dashboards and exports for confident decisions.", items: ["Dashboards", "Exports", "BI"] },
      ],
    },
    process: STANDARD_PROCESS,
    sectors: {
  ...
  },
  {
    ...
    tech: {
      ...
      groups: [
        { label: "Workflow", desc: "Visual, self-hostable workflows that run on autopilot.", items: ["n8n", "Make", "Zapier"] },
        { label: "Connect", desc: "Wire any app to any app with clean, reliable links.", items: ["REST", "Webhooks", "GraphQL"] },
        { label: "Data", desc: "Move and sync data wherever your business keeps it.", items: ["Sheets", "Postgres", "Airtable"] },
        { label: "Channels", desc: "Reach customers and teams on the channels they use.", items: ["Email", "WhatsApp", "Slack"] },
      ],
    },
    process: STANDARD_PROCESS,
    sectors: {
  ...
  },
  {
    ...
    tech: {
      ...
      groups: [
        { label: "Frontend", desc: "A polished, responsive interface for complex apps.", items: ["React", "Next.js", "TypeScript"] },
        { label: "Backend", desc: "A robust data layer built for correctness and scale.", items: ["Node.js", "Postgres", "Prisma"] },
        { label: "Auth & Pay", desc: "Secure access and billing handled the right way.", items: ["Auth.js", "Stripe", "RBAC"] },
        { label: "Infra", desc: "Containerised, monitored hosting that stays up.", items: ["Vercel", "Docker", "Monitoring"] },
      ],
    },
    process: STANDARD_PROCESS,
    sectors: {
  ...
  },
  {
    ...
    tech: {
      ...
      groups: [
        { label: "AI & NLP", desc: "State-of-the-art models tuned to your knowledge base.", items: ["OpenAI", "Claude", "RAG"] },
        { label: "Channels", desc: "Meet customers on WhatsApp, web, and messaging.", items: ["WhatsApp API", "Messenger", "Web widget"] },
        { label: "Integrations", desc: "Plugged into your CRM, calendar, and payments.", items: ["HubSpot", "Calendly", "Stripe"] },
        { label: "Hosting", desc: "Scalable, private hosting with fast vector search.", items: ["Cloud", "Vector DB", "Analytics"] },
      ],
    },
    process: STANDARD_PROCESS,
    sectors: {
  ...
  },
  {
    ...
    tech: {
      ...
      groups: [
        { label: "Design", desc: "Industry-standard tools for pixel-perfect interfaces.", items: ["Figma", "Adobe", "Sketch"] },
        { label: "Prototype", desc: "Clickable prototypes that test ideas before build.", items: ["Figma", "ProtoPie", "Framer"] },
        { label: "Research", desc: "Validate decisions with real user insight.", items: ["Maze", "Hotjar", "Useberry"] },
        { label: "Handoff", desc: "Developer-ready specs, tokens, and components.", items: ["Figma Dev Mode", "Tokens", "Storybook"] },
      ],
    },
    process: STANDARD_PROCESS,
    sectors: {
