        ...
        <section className="sd-section sd-demo">
          ...
          <div className="container">
            ...
            <div className="sd-window reveal">
              <div className="sd-win-bar"><i></i><i></i><i></i><span className="sd-win-url">yoursite.com</span><span className="sd-win-pill"></span></div>
              <div className="sd-win-body">
                <div className="sd-win-nav"><span className="sd-win-logo">{service.name.split(" ")[0].toUpperCase()}</span><span className="sd-win-links"><b></b><b></b><b></b><b></b></span><span className="sd-win-btn"></span></div>
                <div className="sd-win-hero">
                  <div className="sd-win-copy">
                    <span className="sd-win-h"></span><span className="sd-win-h accent"></span>
                    <span className="sd-win-p"></span><span className="sd-win-p short"></span>
                    <span className="sd-win-actions"><span className="filled"></span><span className="ghost"></span></span>
                  </div>
