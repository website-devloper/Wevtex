...
const AiIntelligenceHub: FC = () => {
    return (
                    ...
                    <div className="col-lg-5">
                        <Fade direction="left" triggerOnce duration={1000}>
                            <div className="content-wrapper pr-30">
                                ...
                                >
                                    We don’t just build websites; we engineer fully autonomous digital ecosystems.
                                    By integrating n8n logic pipelines directly into dynamic React architectures,
                                    we eliminate operational friction and unleash infinite scalability.
                                </p>
        ...
        /* OpenAI Node: Bottom left inner ring */
        .node-openai {
          width: 75px;
          height: 75px;
          background-color: var(--color-charcoal);
